...
class TranslationTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        # fmt: off
        #parser.add_argument('data', nargs='+', default='/data/wangzhe/SematicSeg/mlconvgec2018/models/data_bin', help='path(s) to data directorie(s)')
        parser.add_argument('-data', default='/data/wangzhe/SematicSeg/mlconvgec2018/models/data_bin',
                            help='path(s) to data directorie(s)')

        parser.add_argument('-s', '--source-lang', default='src', metavar='SRC',
                            help='source language')
        parser.add_argument('-t', '--target-lang', default='trg', metavar='TARGET',
