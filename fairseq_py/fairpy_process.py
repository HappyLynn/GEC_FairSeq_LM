...
def load(model_names, use_cpu):
    ...
    models, _model_args = utils.load_ensemble_for_inference(model_names, task, model_arg_overrides=eval(args.model_overrides))
    # Set dictionaries
...
def model_predict(inputs, models, generator, align_dict, max_positions, args, use_cuda, task, src_dict, tgt_dict):
    results = []
    start_id = 0
