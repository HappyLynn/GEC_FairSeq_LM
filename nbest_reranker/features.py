...
# For KenLM features
#sys.path.insert(0, '/data/wangzhe/miniconda2/envs/GEC/lib')
import kenlm
...
class LM:
    ...
    def get_score(self, source, candidate, item_idx=None):
        if self.debpe:
...
class EditOps:
    ...
    def get_score(self, source, candidate, item_idx=None):
        ...
        lmatrix, bpointers = levenshtein_matrix(src_tokens, trg_tokens, 1, 1, 1)
